        ...
        <div style="display: flex; justify-content: center">
                    ...
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <div class="card card-body" style="background-color: aliceblue;">
                            <div
                                ...
                                <div id="DivAddItems" style="margin-left: 15px; border-radius: 10px; width: 470px; background-color: aliceblue; color: #000000;">
                                    <br />
                                    <br />
            ...
            <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample2">
                    <div class="card card-body" style="width: fit-content; display: flex; justify-content: center;">
